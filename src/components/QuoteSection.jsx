const QuoteSection = () => (
  <section className="relative py-24 md:py-32 overflow-hidden">
    ...
    <div className="relative max-w-4xl mx-auto px-4 md:px-8 text-center">
      <span className="text-6xl md:text-8xl font-mono text-[#00FFF0]/20 select-none leading-none">
        &ldquo;
      </span>
      <blockquote className="text-2xl md:text-4xl font-bold leading-tight -mt-6 md:-mt-8 px-8 py-6 border-[3px] border-black" style={{ borderRadius: 0, boxShadow: '4px 4px 0 0 #000' }}>
        The only secure system is the one you&apos;ve{' '}
        <span className="text-[#00FFF0]">tested yourself</span>
      </blockquote>
      <p className="mt-6 text-sm font-mono text-[#00FFF0]/50 tracking-wider">
