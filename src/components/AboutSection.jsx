        ...
        <div className="lg:col-span-3 space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-white/60 leading-relaxed">
              Self-driven security researcher passionate about offensive security and infrastructure hardening.
              I build systems to break them&mdash;and fix them. With hands-on experience in vulnerability assessment,
              red team operations, and secure infrastructure design, I bring a practical, results-driven approach
              to every engagement.
            </p>
            <p className="text-white/60 leading-relaxed">
              From contributing custom kernels for Kali NetHunter to building enterprise-grade home labs with
              segregated virtual networks for SIEM simulations, my work bridges the gap between theoretical
              security knowledge and real-world application.
            </p>
          </div>
            ...
            <div className="glass rounded-xl p-5">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs font-mono text-white/40 mt-0.5">Risk Management &amp; Network Defense</p>
                </div>
              </div>
            </div>
            <div className="glass rounded-xl p-5">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs font-mono text-white/40 mt-0.5">Vasantrao More Polytechnic</p>
                </div>
              </div>
            </div>
          </div>
